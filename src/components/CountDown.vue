      ...
      <el-container>
        <el-aside>
          <el-row class="detail status">
            ...
            <el-col :span="10"><span>{{ status }}</span></el-col>
          </el-row>
          ...
          <el-row class="detail pomodoro num">
            <el-col :span="8"><span>番茄个数</span></el-col>
            <el-col :span="10"><span>{{ pomodoroNum }}</span></el-col>
          </el-row>
          <el-row class="detail relax totalTime">
            <el-col :span="8"><span>总休息时长</span></el-col>
            <el-col :span="10"><span>{{ relaxTotalTime }}&nbsp;&nbsp;min</span></el-col>
          </el-row>
        </el-aside>
        <el-main>
          <el-row>
          ...
          <el-row>
            ...
            <el-button :disabled="relaxBtn" @click="startRelax">startRelax</el-button>
          </el-row>
          <el-row>
